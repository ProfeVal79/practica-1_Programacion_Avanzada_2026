...
* Interacción con el usuario: Validación de entradas y formateo de salidas para una experiencia de consola limpia.
* Resolución de problemas lógicos, matemáticos y de manejo de listas.
* Scripts de invocación: Archivos dedicados a probar y ejecutar las funciones importadas.
